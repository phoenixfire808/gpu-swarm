...
3. **Host GPU safety (`host_protect`)** — shipped; live on Host-PC; include in next EXE.
...
| Stable public URL | Durable tunnel / DNS when the host wants friends without Tailscale |
...
- Heavy CUDA / PyInstaller stress on the host desktop during agent work
